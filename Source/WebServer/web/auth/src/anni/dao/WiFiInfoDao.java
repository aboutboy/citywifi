...
public class WiFiInfoDao {
    ...
    public WiFiInfo GetInfo(HttpServletRequest request,HttpServletResponse response)
    	...
    	String auth_server_ip = request.getParameter("aserver");
	    if(auth_server_ip == null) {
			System.out.println("auth_server_ip is null !!");
			return null;
		}
	    mWiFiInfo.setAuthServerIP(auth_server_ip);
	    System.out.println("auth_server_ip: " + auth_server_ip);

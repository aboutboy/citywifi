...
<![endif]-->
<link rel="stylesheet" href="/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?<?php echo ($js_debug); ?>">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/statics/simpleboot/css/simplebootadminindex-ie.css?<?php echo ($js_debug); ?>" />
<![endif]-->
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<script src="/tpl_admin/simpleboot/assets/js/index.js?<?php echo ($js_debug); ?>"></script>

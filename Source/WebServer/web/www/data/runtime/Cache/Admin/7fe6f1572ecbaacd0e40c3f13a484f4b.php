...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" id="myform" action="<?php echo u('page/edit_post');?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
  ...
  <div class="col-auto">
   ...
   <div class="form-actions">
        ...
        <a class="btn" href="/index.php/admin/page">返回</a>
  </div>
 </form>
</div>

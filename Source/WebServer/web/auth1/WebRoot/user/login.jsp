...
<!-- 
                      <tr>
                        ...
                        <td>${mWiFiInfo.authServerIP}</td>
                        </tr>
                        
                      <tr>
                        <td align="right">Remote_IP：</td>
                        <td>${mWiFiInfo.remotePort}</td>
                        </tr>

                      <tr>
                        <td align="right">getAuthClientIP：</td>
                        <td>${mWiFiInfo.authClientIP}</td>
                        </tr>
                        
                      <tr>
                        <td align="right">Auth_Client_MAC：</td>
                        <td>${mWiFiInfo.authClientMAC}</td>
                        </tr>
                        
                      <tr>
                        <td align="right">Auth_Place_ID：</td>
                        <td>${mWiFiInfo.authPlaceID}</td>
                        </tr>
-->
                      <tr>
